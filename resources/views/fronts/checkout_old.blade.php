                ...
                <div class="privacy about">
                    ...
                    <form id="updateCartForm" method="POST">
                        ...
                        <div class="checkout-right">
                            <h4>Your shopping cart contains: <span> {{ count((array) session('cart')) }} Products</span></h4>
                                    ...
                                    @foreach(session('cart') as $id => $details)
                                        ...
                                        <tr class="rem1 something">
                                            ...
                                            <td class="invert-image text-center">
                                                <img src="{{ asset('upload/product') }}/{{  $details['image']}}" alt=" " class="img-responsive" width="50px">
                                            </td>
                                            ...
                                            <td class="invert">
                                                ...
                                                <input type="number" id="number" name="quantity" class="qtyProduct"
                                                ...
                                                <button type="button" data-id="{{$id}}"
                                                        class="updateCart btn btn-outline-primary btn-sm" title="click button after quantity update">
                                            ...
                                            <td class="invert">
                                                <div class="rem">
                                                    {{--<button type="button" data-id="{{$id}}"
                                                            class="updateCart btn btn-primary">
                                                        <i class="fa fa-retweet" aria-hidden="true"></i>
                                                    </button>--}}

                                                    <button type="button" data-id="{{$id}}"
                                                            class="itemDelete btn btn-danger">
                            ...
                            <div class="checkout-left col-md-6 col-sm-12">
                                <div class="checkout-left-basket ">
                                    ...
                                    <ul>
                                        ...
                                        <li>Coupon Discount <i>-</i> <span class="coupon_discount_amount"> {{ $coupon_discount_amount }} %</span>
                                        </li>


                                        <li>Total <i>-</i> <span
                                                class="grandTotal">৳{{ $total-($total*$coupon_discount_amount/100) }}</span>
                                        </li>
                                    </ul>
                                </div>
